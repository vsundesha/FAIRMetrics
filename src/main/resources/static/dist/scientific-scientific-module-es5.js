 ...
 */
var BenchmarkingChallengeListComponent = /** @class */ (function () {
    /**
     * constructor
     */
    function BenchmarkingChallengeListComponent(route, formBuilder, apollo) {
        this.route = route;
        this.formBuilder = formBuilder;
        this.apollo = apollo;
        this.challengeTrigger = new rxjs__WEBPACK_IMPORTED_MODULE_7__["Subject"]();
        this.dtOptions = {};
        this.getChallenges = graphql_tag__WEBPACK_IMPORTED_MODULE_6___default()(templateObject_1 || (templateObject_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"](["\n  query getChallenges($benchmarking_event_id: String!){\n    getChallenges(challengeFilters:{benchmarking_event_id: $benchmarking_event_id}) {\n     _id\n     name\n     orig_id\n     acronym\n    }\n  }\n"], ["\n  query getChallenges($benchmarking_event_id: String!){\n    getChallenges(challengeFilters:{benchmarking_event_id: $benchmarking_event_id}) {\n     _id\n     name\n     orig_id\n     acronym\n    }\n  }\n"])));
        /**
     ...
     * initializer
     */
    BenchmarkingChallengeListComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.apollo.watchQuery({
            ...
            _this.challengeGraphql = result.data;
            _this.loading = result.loading;
            _this.error = result.errors;
            setTimeout(function () {
                _this.challengeTrigger.next();
            });
        });
    };
    /**
     * toogle sellec<
     */
    BenchmarkingChallengeListComponent.prototype.toogle = function (event, value) {
        if (event.checked) {
            this.selectedChallenges.push(value);
        }
        if (!event.checked) {
            var index = this.selectedChallenges.indexOf(value);
            if (index > -1) {
                this.selectedChallenges.splice(index, 1);
            }
        }
        var div = $('.oeb-table').attr('data-benchmarkingevent');
        this.classifier = div + '0';
    };
    BenchmarkingChallengeListComponent.prototype.filterChallenges = function () {
     ...
     */
    BenchmarkingChallengeListComponent.prototype.ngAfterViewInit = function () {
        setTimeout(function () {
            Object(_shared_benchmarkingTable_js__WEBPACK_IMPORTED_MODULE_3__["run_summary_table"])();
        }, 1000);
    };
    BenchmarkingChallengeListComponent.prototype.deselectAll = function () {
        this.selectedChallenges = [];
    };
    /**
     * helper method to get params
     */
    BenchmarkingChallengeListComponent.prototype.getParam = function (param) {
        return this.route.snapshot.paramMap.get(param);
    };
    BenchmarkingChallengeListComponent.ctorParameters = function () { return [
    ...
    return BenchmarkingChallengeListComponent;
}());
 ...
 */
var BenchmarkingDetailComponent = /** @class */ (function () {
    /**
     * constructor
     */
    function BenchmarkingDetailComponent(route, router, apollo) {
        this.route = route;
        this.router = router;
        this.apollo = apollo;
        /**
         ...
         */
        this.loading = true;
        this.getChallenges = graphql_tag__WEBPACK_IMPORTED_MODULE_5___default()(templateObject_1 || (templateObject_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"](["\n  query getChallenges($id: String!){\n    getChallenges(challengeFilters:{id:$id}){\n      _id\n      name\n      acronym\n      metrics_categories {\n        metrics {\n          metrics_id\n          tool_id\n        }\n      }\n    }\n  }\n"], ["\n  query getChallenges($id: String!){\n    getChallenges(challengeFilters:{id:$id}){\n      _id\n      name\n      acronym\n      metrics_categories {\n        metrics {\n          metrics_id\n          tool_id\n        }\n      }\n    }\n  }\n"])));
    }
    /**
     * initializer
     */
    BenchmarkingDetailComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.apollo.watchQuery({
            ...
            .valueChanges.subscribe(function (result) {
            _this.challengesGraphql = result.data;
            _this.loading = result.loading;
            _this.error = result.errors;
        });
        setTimeout(function () {
     ...
     */
    BenchmarkingDetailComponent.prototype.getParam = function (param) {
        return this.route.snapshot.paramMap.get(param);
    };
    BenchmarkingDetailComponent.ctorParameters = function () { return [
    ...
    return BenchmarkingDetailComponent;
}());
 ...
 * component
 */
var BenchmarkingListComponent = /** @class */ (function () {
    function BenchmarkingListComponent(route, router, apollo) {
        this.route = route;
        this.router = router;
        this.apollo = apollo;
         ...
         */
        this.loading = true;
        this.getCommunities = graphql_tag__WEBPACK_IMPORTED_MODULE_4___default()(templateObject_1 || (templateObject_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"](["\n    query getCommunities($community_id: String!){\n      getCommunities (communityFilters:{id:$community_id}){\n        name\n        acronym\n        description\n        status\n      }\n    }\n  "], ["\n    query getCommunities($community_id: String!){\n      getCommunities (communityFilters:{id:$community_id}){\n        name\n        acronym\n        description\n        status\n      }\n    }\n  "])));
        this.getBenchmarkingEvents = graphql_tag__WEBPACK_IMPORTED_MODULE_4___default()(templateObject_2 || (templateObject_2 = tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"](["\n    query getBenchmarkingEvents($community_id: String!){\n      getBenchmarkingEvents(benchmarkingEventFilters: {community_id: $community_id}) {\n        _id\n        name\n        url\n        challenges {\n          _id\n          name\n          url\n        }\n      }\n    }\n  "], ["\n    query getBenchmarkingEvents($community_id: String!){\n      getBenchmarkingEvents(benchmarkingEventFilters: {community_id: $community_id}) {\n        _id\n        name\n        url\n        challenges {\n          _id\n          name\n          url\n        }\n      }\n    }\n  "])));
        this.getDatasets = graphql_tag__WEBPACK_IMPORTED_MODULE_4___default()(templateObject_3 || (templateObject_3 = tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"](["\n    query getDatasets($community_id: String!){\n      getDatasets (datasetFilters: {community_id: $community_id , visibility: \"public\"}) {\n        name\n        type\n      }\n    }\n  "], ["\n    query getDatasets($community_id: String!){\n      getDatasets (datasetFilters: {community_id: $community_id , visibility: \"public\"}) {\n        name\n        type\n      }\n    }\n  "])));
        this.getTools = graphql_tag__WEBPACK_IMPORTED_MODULE_4___default()(templateObject_4 || (templateObject_4 = tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"](["\n  query getTools($community_id: String!){\n    getTools(toolFilters:{community_id: $community_id}) {\n      _id\n      name\n      status\n      description\n    }\n  }\n"], ["\n  query getTools($community_id: String!){\n    getTools(toolFilters:{community_id: $community_id}) {\n      _id\n      name\n      status\n      description\n    }\n  }\n"])));
    }
    /**
     * initializer
     */
    BenchmarkingListComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.apollo.watchQuery({
            ...
            .valueChanges.subscribe(function (result) {
            _this.bEventsGraphql = result.data;
            _this.loading = result.loading;
            _this.error = result.errors;
        });
        this.apollo.watchQuery({
            ...
            .valueChanges.subscribe(function (result) {
            _this.communitiesGraphql = result.data;
            _this.loading = result.loading;
            _this.error = result.errors;
        });
        this.apollo.watchQuery({
            ...
            .valueChanges.subscribe(function (result) {
            _this.datasetsGraphql = result.data;
            _this.loading = result.loading;
            _this.error = result.errors;
            setTimeout(function () {
                _this.datasetTrigger.next();
            });
        });
        this.apollo.watchQuery({
            query: this.getTools,
            ...
            .valueChanges.subscribe(function (result) {
            _this.toolsGraphql = result.data;
            _this.loading = result.loading;
            _this.error = result.errors;
            setTimeout(function () {
                _this.toolTrigger.next();
            });
        });
     ...
     * helper method to get params
     */
    BenchmarkingListComponent.prototype.getParam = function (param) {
        return this.route.snapshot.paramMap.get(param);
    };
    BenchmarkingListComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    ...
    return BenchmarkingListComponent;
}());
 ...
 * scientific list
 */
var ScientificListComponent = /** @class */ (function () {
    /**
     * constructor
     */
    function ScientificListComponent(apollo) {
        this.apollo = apollo;
        /**
         * data
         */
         ...
         */
        this.loading = true;
        this.getCommunities = graphql_tag__WEBPACK_IMPORTED_MODULE_3___default()(templateObject_1 || (templateObject_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__makeTemplateObject"](["\n  {\n    getCommunities {\n      _id\n      name\n      acronym\n      links{\n        label\n        uri\n      }\n    }\n  }\n"], ["\n  {\n    getCommunities {\n      _id\n      name\n      acronym\n      links{\n        label\n        uri\n      }\n    }\n  }\n"])));
    }
    /**
     * initializer
     */
    ScientificListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.apollo
            .watchQuery({
            query: this.getCommunities
    ...
    ScientificListComponent.ctorParameters = function () { return [
    ...
    return ScientificListComponent;
}());
 ...
 */
var ScientificRoutingModule = /** @class */ (function () {
    /**
     * export routing module
     */
    function ScientificRoutingModule() {
    }
    ...
    return ScientificRoutingModule;
}());

/**
 * routing components export
 */
var AllScientificRoutingComponents = [_scientific_list_scientific_list_component__WEBPACK_IMPORTED_MODULE_2__["ScientificListComponent"], _benchmarking_list_benchmarking_list_component__WEBPACK_IMPORTED_MODULE_3__["BenchmarkingListComponent"],
 ...
 */
var ScientificComponent = /** @class */ (function () {
    /**
     * constructor
     */
    function ScientificComponent() {
    }
    /**
     * initializer
     */
    ScientificComponent.prototype.ngOnInit = function () {
    };
 ...
 */
var ScientificModule = /** @class */ (function () {
    function ScientificModule() {
    }
...
var ScientificService = /** @class */ (function () {
     ...
     * constructor
     */
    function ScientificService(http) {
        this.http = http;
        /**
         * production
         */
     ...
     */
    ScientificService.prototype.getCommunities = function () {
     ...
     * gets datasets
     */
    ScientificService.prototype.getDatasets = function () {
     ...
     */
    ScientificService.prototype.getBenchmarkingEvents = function (id) {
     ...
     * gets challenges
     */
    ScientificService.prototype.getChallenge = function (id) {
     ...
     * error handleing
     */
    ScientificService.prototype.handleError = function (operation, result) {
    ...
    ScientificService.ctorParameters = function () { return [
...
//# sourceMappingURL=scientific-scientific-module-es5.js.map