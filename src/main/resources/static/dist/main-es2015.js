...
const routes = [
    ...
    { path: 'tool', loadChildren: () => __webpack_require__.e(/*! import() | tool-tool-module */ "tool-tool-module").then(__webpack_require__.bind(null, /*! ./tool/tool.module */ "./src/app/tool/tool.module.ts")).then(m => m.ToolModule), },
    { path: 'scientific', loadChildren: () => __webpack_require__.e(/*! import() | scientific-scientific-module */ "scientific-scientific-module").then(__webpack_require__.bind(null, /*! ./scientific/scientific.module */ "./src/app/scientific/scientific.module.ts")).then(m => m.ScientificModule) },
...
class AppComponent {
    constructor(router) {
         ...
         */
        this.title = 'app';
        const navEndEvents = router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(event => event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationEnd"]));
...
/* harmony import */ var apollo_angular__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! apollo-angular */ "./node_modules/apollo-angular/fesm2015/ng.apollo.js");
/* harmony import */ var apollo_angular_link_http__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! apollo-angular-link-http */ "./node_modules/apollo-angular-link-http/fesm2015/ng.apolloLink.http.js");
...
const envurl = _environments_environment__WEBPACK_IMPORTED_MODULE_19__["environment"].SCIENTIFIC_SERVICE_URL;
...
let ElasticsearchService = class ElasticsearchService {
    ...
    search(term) {
        ...
        return this.http
            .get(this.ES_URL, { params: this.PARAMS.set('text', term) }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(response => jquery__WEBPACK_IMPORTED_MODULE_6__["map"](response['hits'].hits, function (tool) {
            const t = [];
            t.push(tool['_source'].name);
            return t;
        })));
...
ElasticsearchService.ctorParameters = () => [
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_material_badge__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/material/badge */ "./node_modules/@angular/material/esm2015/badge.js");
...
let PrivateComponent = class PrivateComponent {
     ...
     * Constructor
     */
    constructor(keycloakService, router, location) {
    ...
    logout() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield this.keycloakService.logout(redirectUri);
        });
    }
};
...
class TopMenuComponent {
     ...
     * Construtor method
    */
    constructor(location, keycloakService) {
        this.location = location;
        this.keycloakService = keycloakService;
        /**
